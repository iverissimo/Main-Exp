...
% based on Jason's function, altered for my experiment
%
     ...
     %try
      ...
      switch lower(clsfr_type);
       ...
       case {'ersp','induced'};           
         ...
         pth_plots = sprintf('/Users/s4831829/Main Exp');
         saveas(1, fullfile(pth_plots, sprintf('ersp_sub')), 'png');
         saveas(2, fullfile(pth_plots, sprintf('auc_sub')), 'png');
         saveas(3, fullfile(pth_plots, sprintf('confusion_sub')), 'png');
