...
num_block_cal = 6;%24;%3;                             % number of blocks
...
welcometxt1 = sprintf(['\n\nWelcome to this experiment!' ...
    ...
    '\n\n\nPress the spacebar to continue...'],num_block_cal);

welcometxt2 = sprintf(['\n\nIn the first block you will have to abduct your right toe.' ...
    '\n\nYou will hear 3 low beeps, in order to get ready.' ...
    '\n\n\nPress the spacebar to hear an example...']);

welcometxt3 = sprintf(['\n\nWhen you hear the high pitch, please start the movement.' ...
    '\nAfter a few seconds you will hear a low beep, indicating that the trial is finished.'...
...
comport = '/dev/tty.usbmodem14111'; %'COM5'; %Serial port name for arduino connection
...
welcometxtII_1 = sprintf(['\n\nWelcome to this experiment!' ...
    ...
    '\n\n\nPress the spacebar to continue...'],num_block);

welcometxtII_2 = sprintf(['\n\nThis part of the experiment is similar to' ...
    '\nwhat you did previously.' ...
    '\n\nYou will hear an audio cue, after which you have to' ...
    '\nabdcut your toe, or remain still.'...
    '\n\nYou can move as many times as you which.'...
    '\n\n\nPress the spacebar to continue...']);

welcometxtII_3_1 = sprintf(['\n\nWhen you hear the cue please perform the required movement.'...
    '\n\nDuring the trial you will receive \nfeedback from the robot, according to your performance.' ...
