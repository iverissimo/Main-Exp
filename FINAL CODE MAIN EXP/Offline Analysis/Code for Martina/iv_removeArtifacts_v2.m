function [data, info] = iv_removeArtifacts_v2(data, amplitude_threshold, important_channels,num_ch)
...
nb = open('XXXXX/fieldtrip/template/neighbours/biosemi64_neighb.mat');
