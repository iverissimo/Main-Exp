function [data,events,hdr] = Data_cut_window_offline_FINAL(traindata,traindevents,hdr,tot_trial,train_wndow,init_offset,ovrl,ovrl_wndow)
%
...
if isfield(hdr,'Fs') hdr.fsample = hdr.Fs; end 
if isfield(hdr,'nChans') hdr.nchans = hdr.nChans; end
