...
cfgcls.badchscale = 0; %turn-off the on-line bad-channel code
cfgcls.spatialfilter = 'car+wht'; %spatial filter used
cfgcls.adaptspatfchn = {'EXG1' 'EXG2' 'EXG3' 'EXG4' 'AFz' 'AF3' 'FP1' 'FPz' ...
   'FP2' 'AF4' 'AF8' 'AF7' 'Iz' 'O1' 'Oz' 'O2' 'P9' 'P10' '1/f' 'EMG'};% channels used for artefact removal 

cfgcls.trainOpts = {'width_ms',cfgcls.welch_width_ms,'badtrrm',cfgcls.badtrrm,...
    'badchscale',cfgcls.badchscale,'spatialfilter',cfgcls.spatialfilter,...
