...
if pc == 1 %laptop
    ...
    nm = sprintf('subject%s_test',num2str(subjnum));
    datadir = ['C:/Users/Inês/Main-Exp/troubleshooting/' nm '/raw_buffer/0001'];
    ...
    pth = sprintf('C:/Users/Inês/Main-Exp/plots/sub%s',num2str(subjnum));
